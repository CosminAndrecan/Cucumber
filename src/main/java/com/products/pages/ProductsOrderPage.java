...
public class ProductsOrderPage {
    ...
    public void sendAddressInfo(String name, String street, String city, String state, String zip) {
    ...
    public void sendPaymentInfo(String cardNumber, String expireDate,String cardType) {
    ...
    public void selectCard(String cardType){
        cardType=cardType.toUpperCase().trim();
        switch (cardType){
            case "VISA":
                visaCard.click();
                break;
            ...
            case "AMERICAN EXPRESS":
                ...
                break;
            default:
                System.out.println("card name is not correct.");
                break;
        }
    }
    ...
    public void validation(String name ,String product ,String quantity , String street ,String city ,String state ,String zip ,String cardNumber,String expireDate ,String cardType){
        ...
        Assert.assertEquals(name,BrowserUtils.getText(allData.get(1)));
